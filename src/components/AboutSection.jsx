          ...
          >
            ...
            <div className="relative">
              ...
              <div className="relative aspect-[4/5] w-full rounded-[4px] overflow-hidden border border-black/[0.07] bg-black/[0.04] group">
                ...
                <picture>
                  <source srcSet="/otmane.jpeg" type="image/webp" />
                  <img
                    src="/otmane.jpeg"
                    alt="OTMANE HAMMADI"
                    loading="lazy"
                ...
                <div className="absolute bottom-0 left-0 right-0 px-5 pt-10 pb-4 bg-gradient-to-t from-black/65 via-black/30 to-transparent z-20">
                  ...
                  <p className="text-white font-bold text-[15px] tracking-wide leading-snug">OTMANE HAMMADI </p>
                </div>
            ...
            <div className="mt-4 grid grid-cols-2 gap-2.5">
              ...
              <div className="bg-white border border-black/[0.08] rounded-[3px] py-3.5 px-4">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-[13px] font-bold text-black">MOROCCO</span>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col">
            ...
            >
              ...
              <h2 className="font-display font-bold tracking-[-0.025em] leading-[1.08] text-black">
                ...
                <span className="block text-[22px] sm:text-[26px] lg:text-[30px] xl:text-[34px] font-medium tracking-[-0.01em] text-black/55 mt-2">
                  With End-to-End Product Delivery
                </span>
              </h2>
            </Gsap.div>
            ...
            >
              ...
              <span className="font-mono text-[10px] md:text-[10.5px] uppercase tracking-[0.2em] text-black/35">
                Computer Vision · LLM Systems · Scalable Applications
              </span>
            </Gsap.div>
            ...
            >
              <p>
                I'm <strong className="text-black font-semibold">OTMANE HAMMADI</strong>, a full-stack developer specialized in AI and data, building intelligent systems designed for real-world performance, scalability, and impact.
              </p>
              <p>
               My work focuses on Computer Vision and LLM-based applications, delivering complete solutions from idea to production-ready products
              </p>
            </Gsap.div>
